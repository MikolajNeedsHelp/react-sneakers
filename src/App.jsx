...
function App() {
  ...
  const onRemoveItem = async (id) => {
    const object =  await axios.get(`https://651831b1582f58d62d357d58.mockapi.io/cart?id=${id}`).then(res => res.data[0]);

    await axios
      .delete(`https://651831b1582f58d62d357d58.mockapi.io/cart/${object.cart_id}`)
      .then(() => {
      ...
      <div className="content p-40">
        <div className="d-flex align-center justify-between mb-40">
          ...
          <div className="search-block d-flex">
            ...
            {searchValue && (<img className='remove_input-btn' src="/img/btn-remove.svg" alt="search" onClick={() => setSearchValue("")}/>)}
            <input
        ...
        <div className="card-wrapper d-flex flex-wrap">
          {items.filter((item) => item.title.toLowerCase().includes(searchValue)).length ? items
